...
# Inside Claude Code, only read .claude/session-color. Do not invoke external
# session helpers from this Bash body; see references/maintenance-history.md for
# pure Codex-Claude session notes.
